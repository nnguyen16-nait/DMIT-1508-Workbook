...
-- create, but the only ones we're intereste in here are the kind that
...
-- 3) Becuase it's a "stored" query on the database the database engine can
--    perfrom some "optimization" to make it run quite quickly.
